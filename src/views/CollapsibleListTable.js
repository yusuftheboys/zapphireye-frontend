                ...
                <TableBody>
                  {row.alert.map((alertRow) => (
                    <TableRow key={alertRow.pluginid}>
                      <TableCell component="th" scope="row">{alertRow.pluginid}</TableCell>
                      ...
                      <TableCell align="center">{alertRow.reference}</TableCell>
                      <TableCell align="center">
                          <Button onClick={() => navigate('/desc', {state: alertRow})}>
                              Description
                          </Button>
                      </TableCell>
                    </TableRow>
